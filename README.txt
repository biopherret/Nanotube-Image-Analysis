...
add_day_to_database.py using the name of a new imaging date folder, and names of the slide folders to prompt the user for all of the anneal conditions of the sample and uploads them to the SQL server
